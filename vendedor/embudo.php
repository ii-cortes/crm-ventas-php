...
<div class="row g-3">
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-secondary border-0 p-0 px-1 btn-editar-contacto" 
                                    ...
                                    data-comuna="<?php echo htmlspecialchars($c['comuna'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" title="Editar Contacto">
                    ...
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-warning border-0 p-0 px-1 btn-editar-agenda" 
                                    ...
                                    data-correo="<?php echo htmlspecialchars($c['correo'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" title="Reprogramar Hora">
    ...
    <div class="col-md-3">
        <div class="bg-light p-3 rounded shadow-sm border-top border-4 border-danger h-100">
            <h6 class="fw-bold text-danger text-uppercase mb-3">3. Citas Realizadas (<span class="badge bg-danger"><?php echo count($etapa3); ?></span>)</h6>
            <?php foreach ($etapa3 as $c): ?>
                <div class="card mb-2 shadow-sm border-0 border-start border-3 border-danger">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-start">
                            <h6 class="fw-bold mb-1 text-dark"><?php echo htmlspecialchars($c['nombre_completo'] ?? '', ENT_QUOTES, 'UTF-8'); ?></h6>
    ...
    <div class="col-md-3">
        <div class="bg-light p-3 rounded shadow-sm border-top border-4 border-success h-100">
            ...
            <?php foreach ($etapa4 as $c): ?>
                <div class="card mb-2 shadow-sm border-0 border-start border-3 border-success bg-white opacity-75">
                    <div class="card-body p-3">
                        <h6 class="fw-bold mb-1 text-dark"><?php echo htmlspecialchars($c['nombre_completo'] ?? '', ENT_QUOTES, 'UTF-8'); ?></h6>
        ...
        <div class="modal-content border-0 shadow">
            ...
            <form action="../ajax/avanzar_etapa4.php" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <p class="small text-muted mb-3">Ingresa 3 contactos proporcionados por el cliente.</p>
