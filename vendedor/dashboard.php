...
if ($ventas_actuales > 0) {
    $texto_motivador = "Espectacular. Llevas {$ventas_actuales} cierres de contratos exitosos {$texto_temporal}. Sigue así.";
} else {
    $texto_motivador = "Llevas {$prospectos_actuales} de {$prospectos_meta} prospectos con movimientos {$texto_temporal}. Acelera el embudo.";
}
?>
