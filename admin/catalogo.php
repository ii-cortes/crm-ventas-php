...
try {
    ...
    die("Error al cargar el catalogo.");
}
?>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="tipo" required maxlength="50">
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="descripcion_corta" required maxlength="255">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">Descripción Detallada / Larga</label>
                        <textarea class="form-control" name="descripcion_larga" rows="4"></textarea>
                    </div>
                </div>
